const translations = {
  zh: {
    ...
    languageKicker: "熟悉的语言，更少的误解", languageTitle: "简体中文 · 繁體中文 · 日本語 · English", languageBody: "从首次设置到工资单常见词汇，App 界面支持四种语言。你可以随时切换，不必重新开始。",
  ...
  ja: {
    ...
    languageKicker: "慣れた言葉で、誤解を減らす", languageTitle: "簡体中文 · 繁體中文 · 日本語 · English", languageBody: "初期設定から給与明細の用語まで、アプリは4言語に対応。いつでも切り替えられ、やり直す必要はありません。",
  ...
  en: {
    ...
    languageKicker: "Familiar language, fewer misunderstandings", languageTitle: "Simplified · Traditional Chinese · Japanese · English", languageBody: "From setup to common payslip terms, the app supports four interface languages. Switch any time without starting over.",
